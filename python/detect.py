...
def main():
    ...
    # Step 4: Handle detection results (Phase 8: Validated confidence threshold & Unknown handling)
    ...
    # Primary detection is the highest-confidence match
    primary = detections[0]
    actual_conf = primary["confidence"]

    # If the validated threshold is not met, do not force a species; report 'Unknown' with actual confidence
    if actual_conf < CONFIDENCE_THRESHOLD:
        species_out = "Unknown"
    else:
